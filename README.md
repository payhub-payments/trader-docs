...
1.1.1 При торговле СБП регламент всех мерчей, кроме 1 (одного) не требует 1 номер - 1 банк, что означает закрытия диспута в вашу сторону при ошибочном переводе в другой банк и невозможности проверить и подтвердить перевод (блок ЛК, приставы, арест, игнор контрагента). Если диспут от мерчанта с требованием по регламенту 1 номер - 1 банк, то закрытие будет в сторону клинета (ВАЖНО❗️)
