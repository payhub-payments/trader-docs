...
1.1.1 При торговле по системе СБП клиент может перевести средства на другой банк. В таком случае просим вас проверить перевод на другой банке, если есть такая возможность. Если ее нет (блок, приставы, нет доступов), то напишите нам в чате и мы отменим данную сделку.
